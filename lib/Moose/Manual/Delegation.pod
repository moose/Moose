...
summarized below.  For more information about each of these provided 
methods see the documentation for that specific trait.
...
The following methods are provided by the native Array trait:
  ...
  count, is_empty, elements, get, pop, push, shift,
  unshift, splice, first, first_index, grep, map,
  reduce, sort, sort_in_place, shuffle, uniq, join,
  set, delete, insert, clear, accessor, natatime,
  shallow_clone
...
The following methods are provided by the native Hash trait:
  ...
  get, set, delete, keys, exists, defined, values, 
  kv, elements, clear, count, is_empty, accessor, 
  shallow_clone
...
The following methods are provided by the native Number trait:
  ...
  inc, append, prepend, replace, match, chop, chomp, 
  clear, length, subtr
