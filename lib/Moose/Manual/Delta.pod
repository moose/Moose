...
=item Fixed the Num builtin type to reject NaN, Inf, numbers with whitespace, and other questionable strings

Previously, C<Num> was using L<Scalar::Util/looks_like_number>, which accepts
numbers with whitespace, Inf, NaN, Infinity, "1\n", "\n1", "0.", "0 but true" etc as valid Num. But now, 
Num accepts only integers, floating point numbers (both in decimal notation and exponential 
