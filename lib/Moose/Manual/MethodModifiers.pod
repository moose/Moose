...
function being modified isn't passed in any way; this syntax is only
intended for cases where the function being modified doesn't actually
matter. If the function name does matter, use something like this:
