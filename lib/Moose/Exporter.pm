...
as well as your own, along with sugar from any random L<MooseX> module, as
long as they all use L<Moose::Exporter>. This feature exists to let you bundle
a set of MooseX modules into a policy module that developers can use directly
instead of using Moose itself.

To simplify writing exporter modules, L<Moose::Exporter> also imports
...
When you call this method, L<Moose::Exporter> builds custom C<import> and
...
wants to export. These modules must also use L<Moose::Exporter>. The
...
L<Moose::Exporter> also makes sure all these functions get removed
...
from other modules that use L<Moose::Exporter>. This function is
...
L<Moose::Exporter> generates for you will call this method (if it exists). It
...
The C<import> method generated by L<Moose::Exporter> will allow the
